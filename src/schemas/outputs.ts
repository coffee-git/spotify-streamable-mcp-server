...
export const SpotifySearchBatchOutput = z.object({
  ...
  batches: z.array(z.object({
    ...
    items: z.array(z.union([SlimTrackSchema, SlimAlbumSchema, SlimArtistSchema, SlimPlaylistSchema])),
  })),
});
...
export const SpotifyControlBatchOutput = z.object({
  ...
  results: z.array(z.object({
    ...
    code: z.enum(['unauthorized', 'forbidden', 'rate_limited', 'bad_response']).optional(),
  })),
...
const GenericToolOutputObject = z.object({
  ok: z.boolean(),
  action: z.string(),
  _msg: z.string().optional(),
...
export const SpotifyPlaylistOutputObject = GenericToolOutputObject;
export type SpotifyPlaylistOutputObject = z.infer<typeof SpotifyPlaylistOutputObject>;
export const SpotifyLibraryOutputObject = GenericToolOutputObject;
export type SpotifyLibraryOutputObject = z.infer<typeof SpotifyLibraryOutputObject>;
export const SpotifyUserDataOutputObject = GenericToolOutputObject;
export type SpotifyUserDataOutputObject = z.infer<typeof SpotifyUserDataOutputObject>;
